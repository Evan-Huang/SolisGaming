        ...
        <div class="promotions_content">
            <div class="col-lg-12 hidden-xs">
                <div class="crumb">
                    ...
                    <label style="display: inline;font-weight: normal;">Join Club Solis, Rewards $50 E-bonus/Shopping Voucher</label>
                </div>
            </div>
            <div class="col-md-5">
            ...
            <div class="col-md-7">
                <div class="promotion_detail">
                    <div class="promotion_title">Join Club Solis, Rewards $50 E-bonus/Shopping Voucher</div>
                    <div class="promotion_content">
                        <p>Join us to be New Club Solis member and earn 100 points or above on the first two days (on the register day from 00:00 to the following day 23:59), can have $50 E-bonus/shopping voucher for FREE.</p>
            ...
            <div class="col-md-12">
                <div class="promotion_detail" style="line-height: 30px;padding: 20px 0">
                    ...
                    <ol>
                        ...
                        <li>All qualify new members can only participate “Join Club Solis, Rewards $50 E-bonus/shopping voucher” promotion for one time.</li>
                        ...
                        <li>All New Sign Up rewards need to collect at one time, E-bonus need to use up on one machine.</li>
                        <li>E-bonus only apply on card members.</li>
                        <li>SSolis management shall be final.</li>
