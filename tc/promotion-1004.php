        ...
        <div class="promotions_content">
            <div class="col-lg-12 hidden-xs">
                <div class="crumb">
                    ...
                    <label style="display: inline;font-weight: normal;">加入永昱會，賞您$50即賞錢／購物禮券！</label>
                </div>
            </div>
            <div class="col-md-5">
            ...
            <div class="col-md-7">
                <div class="promotion_detail">
                    ...
                    <div class="promotion_content">
                        <p>成為永昱會新會員首兩天耍樂（成為會員當日00:00至翌日晚上23:59），賺取100積分，即送您$50即賞錢／購物禮劵！</p>
                        <p>推廣日期：由即日起至2017年5月31日</p>
                        <div class="row">
                            <div class="col-md-4 promotion_content_row_col">
                                <p style="padding: 5px;" class="text-center">獲獎方法</p>
                                <p style="padding: 15px;" class="text-left">成為永昱會新會員，並於成功申請當日00:00至翌日晚上23:59前於成功申請之永昱會角子機耍樂並賺取100分。</p>
                            </div>
                            <div class="col-md-2 promotion_content_row_col">
                                <p style="padding: 5px 10px;" class="text-center">獎賞</p>
                                <p style="padding: 55px 5px;" class="text-center">$50即賞錢 / 購物禮劵</p>
                            </div>
