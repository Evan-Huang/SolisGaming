            ...
            <div class="promotions_content">
                <div class="col-lg-12 hidden-xs">
                    <div class="crumb">
                        ...
                        <label style="display: inline;font-weight: normal;">加入永昱会，赏您$50即赏钱／购物礼券！</label>
                    </div>
                </div>
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                    <div class="promotion_detail">
                        <div class="promotion_title">加入永昱会，赏您$50即赏钱／购物礼券！</div>
                        <div class="promotion_content">
                            <p>成为永昱会新会员首两天耍乐（成为会员当日00:00至翌日晚上23:59），赚取100积分，即送您$50即赏钱／购物礼劵！</p>
                            <p>推广日期：由即日起至2017年5月31日</p>
                            <div class="row">
                                <div class="col-md-4 promotion_content_row_col">
                                    <p style="padding: 5px;" class="text-center">获奖方法</p>
                                    <p style="padding: 15px;" class="text-left">成为永昱会新会员，并于成功申请当日00:00至翌日晚上23:59前于成功申请之永昱会角子机耍乐并赚取100分。</p>
                                </div>
                                <div class="col-md-2 promotion_content_row_col">
                                    <p style="padding: 5px 10px;" class="text-center">奖赏</p>
                                    <p style="padding: 55px 5px;" class="text-center">$50即赏钱 / 购物礼劵</p>
                                </div>
