  ...
  <div class="container ">
    ...
    <div class="row white_bg" id="who">
      ...
      <div class="col-md-6 who_text_p">
          ...
          <p>「SOLIS永昱」源自于西班牙语太阳的意思、拥有着宇宙间最耀眼而强大的能量、自古印加的信念到现代的文明社会里、太阳一直象征着生命、能量及权力之源、并能转化为卓越的成就及带来兴奋刺激的感官。</p>
          <p>太阳更在日出日落时发放醉人金光，如黄金般夺目耀眼，好比万世追求的幸运、成功与财富。</p>
          <p>来「SOLIS永昱」，感受震撼的感官体验并成为宇宙皇者 !</p>
      </div>
    </div>
    <!-- Who we are -->
    <div class="row who_bg" id="about">
      <div class="col-lg-12">
        <div class="who_text_box text-justify">
          <h2 class="text-center">关于永昱</h2>

          <p>永昱于2016年成立，集合了一班专注管理亚洲博彩市场的精英加入此集团品牌。本集团之高级管理团队在亚洲营运赌场及居住超过15年，足迹遍布澳门、越南及菲律宾。</p>
          <p class="hide">胜龙星球娱乐投资与策划有限公司(SDGI)的博彩业务由胜龙国际控股有限公司(HKEX1182)及愿景娱乐集团有限公司合资拥有；永昱更成为胜龙星球娱乐投资与策划有限公司(SDGI)旗下全资拥有的品牌。</p>
          <p>永昱总公司驻扎香港，并分别于澳门及越南设有办事处，公司的精英团队均拥有非常丰富的娱乐场营运及管理经验，对赌台及角子机业务特别了如指掌，团队目前正全力部署庞大的亚洲拓展计划。</p>
          <p>永昱之管理层均拥有过人的魄力与干劲，勇于打破墨守成规并提出创新思维，具有高瞻远瞩的视野。我们更孜孜不倦地发掘不同的发展机遇，从而进一步巩固我们在市场上的竞争优势。凭借我们一直对诚信的执着与坚持，我们已成功地在亚洲的娱乐场管理及博彩投资等相关合作项目建立了超卓的信誉，与合作伙伴共同分享丰盛的成果。</p>

          <p>澳门拥有全球最大及受高度管制的博彩市场，我们在4个营业地点中共营运超过650台电子博彩机（其中3个营业地点均由永昱​​拥有）</p>
          <p>在3个地点营运:</p>
          <ul class="text-left">
              <li>皇家金堡酒店 – 2013年成立 - 130台电子博彩机</li>
              <li>澳门君怡酒店 – 2013年成立 - 150 台电子博彩机</li>
              <li>澳门置地广场酒店– 2013年成立 - 150 台电子博彩机</li>
              <li>金碧汇彩娱乐场 – 2009 年成立 – 195 台电子博彩机(永昱只负责营运管理)</li>
          </ul>
        </div>
    ...
    <div class="row local_bg" id="location">
      <div class="col-lg-12 black_bg">
        <h2 class="text-center">澳门永昱位置</h2>
      </div>
      <div class="col-sm-12">
    ...
    <div class="row club_bg" id="club">
      <div class="col-lg-12">
        <h2 class="text-center">永昱会</h2>
      </div>
      <div class="col-md-6 local_place_bg">
        <div class="local_desc text-justify" style="color: #ffffff">

            <p>欢迎莅临永昱会！贵为深受欢迎的贵宾会会员计划，我们为你准备多重精彩的刺激体验，数之不尽的珍贵礼品及丰富回赠，非凡的尊贵礼遇及独一无二的贴心贵宾客户服务。</p>
            <p>请立即投入这个炙手可热的国度，尽情体验及享受一系列为你精心打造的超级体验及多种惊喜礼遇！</p>
	...
	<div class="col-md-12 local_place_bg ">
		 ...
		 <h4 >昱星</h4>
          <p>欢迎您加入永昱会，成为昱星会员并迈向胜利之门及开始赚取积分换取精彩礼遇!</p>
			</td>
		 ...
		 <h4 >昱月</h4>
        <p>由昱星升级至昱月：只需在过去6个月内赚取3,888 分或以上</p>
			</td>
			<td align="center">
			...
			<td style="padding-left: 6%">
		 <h4 >宇宙</h4>
          <p>由昱月升级至宇宙：只需在过去6个月内赚取26,888分或以上</p>
			</td>
			<td align="center">
			...
			<td style="padding-left: 6%">
		 <h4 >太极</h4>
          <p>由宇宙升级至太极，只限被邀请之贵宾会员，可尊享为您贴心制订的个人化客户服务及设施</p>
			</td>
			<td align="center">
